...
SUB_LEAGUES_2246 = {
    ...
    "Women's League": [711677, 762053, 60380, 36548, 3578266, 50762, 2580160, 3464492, 7533609, 101565, 1558072, 13682, 17833, 667332, 383788, 1736752, 8219064, 360117, 683048, 1791917, 8280954, 7197079, 30488, 4872, 5498163, 5365490, 43917, 3625586, 201778]
}
...
if st.sidebar.button("Run Analysis"):
    ...
    if multi_gw_enabled and num_gameweeks > 1:
        column_renames = {
            ...
            'transfer_gain': f'Transfer Gain/Loss ({num_gameweeks} GWs)',
            'points_on_bench': f'Bench Pts ({num_gameweeks} GWs)',
